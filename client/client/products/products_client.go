...
type ClientService interface {
	...
	PostProduct(params *PostProductParams, opts ...ClientOption) (*PostProductOK, error)

	PutProduct(params *PutProductParams, opts ...ClientOption) (*PutProductCreated, error)
...
/*
PostProduct Create a new product
*/
func (a *Client) PostProduct(params *PostProductParams, opts ...ClientOption) (*PostProductOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
	...
	success, ok := result.(*PostProductOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for postProduct: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}

/*
PutProduct Updates Product by ID
*/
func (a *Client) PutProduct(params *PutProductParams, opts ...ClientOption) (*PutProductCreated, error) {
	// TODO: Validate the params before sending
	if params == nil {
